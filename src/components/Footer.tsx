...
import { FireIcon, LightBulbIcon, HeartIcon, ShoppingBagIcon, EnvelopeIcon, CalendarIcon, TagIcon, MagnifyingGlassIcon, SparklesIcon, ArrowTrendingDownIcon, ClockIcon, TrophyIcon, BellIcon, BoltIcon, MapPinIcon, GiftIcon } from '@heroicons/react/24/outline';
...
const footerLinks = [
  ...
  { label: 'Community Picks', to: '/deals/community-picks', icon: HeartIcon },
  ...
  { label: 'Bundle Deals',    to: '/deals/bundles',      icon: GiftIcon },
  ...
  { label: 'All Stores',       to: '/stores',                icon: ShoppingBagIcon },
  { label: 'Leaderboard',      to: '/leaderboard',           icon: TrophyIcon },
  { label: 'Price Drop Leaderboard', to: '/leaderboard/price-drops', icon: ArrowTrendingDownIcon },
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Newsletter signup inline (compact) */}
        <div className="bg-orange-50 dark:bg-orange-900/20 rounded-2xl p-4 mb-8 flex flex-col sm:flex-row items-center gap-4">
          <div className="flex-1 min-w-0">
            <p className="font-bold text-gray-900 dark:text-white text-sm">Never miss a deal</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Top Australian deals in your inbox. Free, weekly, no spam.</p>
            {subscriberCount !== null && subscriberCount > 0 && (
              <p className="text-xs text-orange-500 font-semibold mt-0.5">{subscriberCount.toLocaleString()} subscribers</p>
            )}
          </div>
          {footerSubStatus === 'success' ? (
            <p className="text-sm text-emerald-600 dark:text-emerald-400 font-medium whitespace-nowrap">You're subscribed!</p>
          ) : (
            <form onSubmit={handleFooterSubscribe} className="flex gap-2 w-full sm:w-auto">
              <input
                type="email"
                value={footerEmail}
                ...
                required
                className="flex-1 sm:w-52 border border-orange-200 dark:border-orange-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 text-sm px-3 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              <button
                type="submit"
                disabled={footerSubStatus === 'loading'}
                className="flex items-center gap-1 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors whitespace-nowrap"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">OzVFY is an Australian price comparison service</p>
            <div className="flex items-center gap-3 mt-4">
              {/* Twitter/X */}
              <a href="https://x.com/hub_aussie52616" target="_blank" rel="noopener noreferrer" aria-label="OzVFY on X" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 hover:text-orange-500 transition-colors">
              ...
              {/* Telegram */}
              <a href="https://t.me/ozvfy" target="_blank" rel="noopener noreferrer" aria-label="OzVFY on Telegram" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 hover:text-orange-500 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8l-1.68 7.94c-.12.56-.44.7-.9.44l-2.52-1.86-1.2 1.16c-.14.14-.26.26-.52.26l.18-2.6 4.72-4.26c.2-.18-.04-.28-.32-.1l-5.84 3.68-2.5-.78c-.54-.18-.56-.54.12-.8l9.74-3.76c.46-.16.86.12.72.78z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/aussiedealshub/" target="_blank" rel="noopener noreferrer" aria-label="OzVFY on Instagram" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 hover:text-orange-500 transition-colors">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/aussiedealshub" target="_blank" rel="noopener noreferrer" aria-label="OzVFY on Facebook" className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 hover:text-orange-500 transition-colors">
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 mt-10 pt-6 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            <p className="text-xs text-gray-400">OzVFY is an Australian price comparison service</p>
            <a href="mailto:ads@ozvfy.com" className="text-xs text-orange-500 hover:underline">Advertise with us</a>
          </div>
        </div>
      </div>
    </footer>
