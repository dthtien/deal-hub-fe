        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xl font-bold text-gray-900">OzVFY</span>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
              Australia's smartest deal finder. We crawl top stores daily so you never miss a bargain.
            </p>
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.facebook.com/aussiedealshub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 hover:text-orange-500 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
              </a>
              <a href="https://www.instagram.com/aussiedealshub/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 hover:text-orange-500 transition-colors">
              ...
              <a href="https://x.com/hub_aussie52616" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-100 hover:text-orange-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {footerLinks.map(l => (
                <li key={l.to}>
                  <Link to={l.to} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-orange-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={l.label}>
                  <a href={l.href} className="text-sm text-gray-500 hover:text-orange-500 transition-colors">{l.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="col-span-full sm:col-span-1">
            ...
            <p className="text-sm text-gray-500 mb-3">Top 10 deals every Monday. Free.</p>
