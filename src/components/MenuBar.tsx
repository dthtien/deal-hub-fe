  ...
  return (
    <>
      ...
      <header className="bg-gray-50 sticky top-0 z-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <Link to="/" className="flex items-center gap-2 flex-shrink-0">
              ...
              <span className="font-bold text-lg text-gray-900 hidden sm:block">OzVFY</span>
            </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              {user ? (
                <Menu as="div" className="relative">
                  <Menu.Button className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                    ...
                    <ChevronDownIcon className="w-3.5 h-3.5 text-gray-500 hidden sm:block" />
                  </Menu.Button>
                ...
                <button
                  ...
                  className="hidden sm:flex items-center gap-1.5 bg-gray-200 text-gray-700 hover:bg-gray-300 text-sm font-semibold px-4 py-2 rounded-xl transition-colors shadow-sm"
                >
                  Log in
                </button>
              )}
              ...
              {/* Mobile menu toggle */}
              <button onClick={() => setMobileOpen(!mobileOpen)} className="sm:hidden p-2 rounded-lg text-gray-700 hover:bg-gray-200">
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="sm:hidden bg-gray-50 px-4 pb-4">
            {!user && (
